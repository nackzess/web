                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-material" action="update_db.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <!-- <a class="btn btn-danger float-right" href="index2.php?UserName22=<?php //echo $val->Email; ?>" onclick='return checkdelete()'> Delete User</a>  -->
                                            <button class="btn btn-success" type="submit"> Update Profile</button> 
                                        </div>
                                        <input type="hidden" value="<?=$r['id']?>" name="id" >
                                        <input type="hidden" value="1" name="std" >
                                    </form>
                                </div>
                            </div>
                        </div>
