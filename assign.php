                    ...
                    <div>
                        <div>
                            <form action="assign_db.php" method="post" class="form-horizontal my-5">
                                ...
                                <div class="form-group">
                                    <label for="teacher" class="col-sm-3 control-label">Teacher</label><br>
                                    <div class="col-sm-12">
                                        <select class="form-select" name="teach" required placeholder="Select Teacher">
                                            <option value="" selected>Open this select Teacher</option>
                                            <option value="1">Zoom ID 1</option>
                                            <option value="2">Zoom ID 2</option>
                                            <option value="3">Zoom ID 3</option>
                                        </select>
                                    </div>
