...
if($Username != NULL){
    ...
    $sql = "INSERT INTO masterlogin (Firstname,Lastname,email,password,section,role,start_date) VALUES ('$firstname', '$lastname', '$email', '$password', '$section', '$status', '$create_date')";
